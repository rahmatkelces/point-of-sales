...
git clone https://github.com/rahmatkelces/point-of-sales.git
...
-   **Rahmat Nurcahyanto** ([rahmatkelces](https://github.com/rahmatkelces)

-   Aplikasi ini menggunakan resource dari [RILT-Starter](https://github.com/Raf-Taufiqurrahman/RILT-Starter) dengan beberapa modifikasi yang saya lakukan terhadap komponen-komponen untuk mendukung aplikasi kasir
...
Made with ❤️ menggunakan Laravel + React oleh **Rahmat Nurcahyanto**.
